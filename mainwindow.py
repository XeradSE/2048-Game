...
from PyQt6.QtWidgets import QApplication, QMainWindow, QLabel, QGridLayout, QWidget, QMessageBox
...
class MainWindow(QMainWindow):
    ...
    def show_game_over_dialog(self):
        ...
        msg.setText(f"Plus aucun mouvement possible.\nTon score final : {self.game.score}")
        ...
        if result == QMessageBox.StandardButton.Retry:
            self.game = logic2048.Game() # On recrée un jeu neuf
            self.update_interface()
        else:
            self.close()